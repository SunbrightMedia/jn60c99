// sub_1803C8120  @ 0x1803C8120  (RVA 0x3C8120)
// prototype: __int64 __fastcall(_QWORD, _QWORD)
// callees: 0x1802F8C90, 0x1802FB610, 0x180306830, 0x18034B2A0, 0x1803C5070, 0x1803C8120, 0x18067522C, 0x180675D20
// constants/globals referenced:
//   0x180C94EF8 [.data] __security_cookie  u32=769630770  f32=2.5424194000089884e-11  f64=2.3683975271087e-310
//   0x1809348A8 [.idata] __imp_CreateSemaphoreA  u32=4294967295  f32=nan  f64=nan
...
//   0x180934868 [.idata] __imp_DuplicateHandle  u32=4294967295  f32=nan  f64=nan

// Hidden C++ exception states: #wind=9
_QWORD *__fastcall sub_1803C8120(__int64 a1, _QWORD *a2)
{
  ...
  if ( *(_QWORD *)(a1 + 24) == v6 || (v7 = *(_QWORD *)(v6 - 8), *(_BYTE *)(v7 + 20)) )
  {
    ...
    if ( *(_QWORD **)(a1 + 40) == v15 )
    {
      sub_1803C5070((unsigned __int64 *)(a1 + 24), v15, (__int64 *)&v22);
    }
    else
    {
      *v15 = v11;
