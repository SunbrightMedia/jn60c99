# PROJECT HISTORY — the full dated log that used to be CLAUDE.md
(Moved 2026-08-13 on the user's order. NOTHING was deleted; CLAUDE.md now holds
rules and pointers only. Every ★/⚑ block, work order and caveat below is
verbatim. If a fact here conflicts with FINAL_GUIDE.md or a data doc, the doc
wins — much of this log is superseded and kept for provenance.)
