...
void juno_apply_delay(unsigned char *state, const unsigned char *rec)
{
    ...
    if (dtype > 5) dtype = 5;
    *(int32_t *)ebdev_at((unsigned long)(JUNO_PROG_DLY)) = (int32_t)dtype;  /* per-patch slot-1 mode */
    ...
    *(int32_t *)ebdev_at((unsigned long)(95828))    = 0x400;
    *(int32_t *)ebdev_at((unsigned long)(101028))   = 0x400;
    *(int32_t *)ebdev_at((unsigned long)(2199956))  = 0x80000;
    *(int32_t *)ebdev_at((unsigned long)(4297124))  = 0x80000;
    *(int32_t *)ebdev_at((unsigned long)(6395252))  = 0x80000;
    *(int32_t *)ebdev_at((unsigned long)(6429412))  = 0x2000;
    *(int32_t *)ebdev_at((unsigned long)(6463716))  = 0x2000;
    *(int32_t *)ebdev_at((unsigned long)(6496500))  = 0x2000;
    *(int32_t *)ebdev_at((unsigned long)(8594772))  = 0x80000;
    *(int32_t *)ebdev_at((unsigned long)(10691940)) = 0x80000;
    *(int32_t *)ebdev_at((unsigned long)(10726260)) = 0x2000;
    *(int32_t *)ebdev_at((unsigned long)(10759044)) = 0x2000;
