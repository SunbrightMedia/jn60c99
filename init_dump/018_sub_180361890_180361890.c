// sub_180361890  @ 0x180361890  (RVA 0x361890)  floats=21
...
double __fastcall sub_180361890(__int64 a1, int a2, int a3)
{
  int v6; // r9d
  __int64 v7; // r8
  __int64 v8; // rdx
  ...
  *(_DWORD *)(a1 + 32) = a3;
  sub_180356380((__int64)&unk_180CB0DC8, 58, a3);
  ...
  if ( a2 )
  {
    ...
    sub_1803C1090(*(_QWORD *)(a1 + 8), *(unsigned int *)(a1 + 152), *(unsigned int *)(a1 + 232));
    sub_1803C1090(*(_QWORD *)(a1 + 8), *(unsigned int *)(a1 + 152), *(unsigned int *)(a1 + 236));
    sub_1803C1090(*(_QWORD *)(a1 + 8), *(unsigned int *)(a1 + 152), *(unsigned int *)(a1 + 240));
    sub_1803C1090(*(_QWORD *)(a1 + 8), *(unsigned int *)(a1 + 152), *(unsigned int *)(a1 + 244));
  }
  else
  {
    sub_1803C10D0(v17, v16, v14, 5 * v15, 0);
    sub_1803C10D0(*(_QWORD *)(a1 + 8), *(_DWORD *)(a1 + 152), *(_DWORD *)(a1 + 232), v18, 0);
    sub_1803C10D0(*(_QWORD *)(a1 + 8), *(_DWORD *)(a1 + 152), *(_DWORD *)(a1 + 236), v19, 0);
    sub_1803C10D0(*(_QWORD *)(a1 + 8), *(_DWORD *)(a1 + 152), *(_DWORD *)(a1 + 240), v20, 0);
    sub_1803C10D0(*(_QWORD *)(a1 + 8), *(_DWORD *)(a1 + 152), *(_DWORD *)(a1 + 244), v21, 0);
  }
