// sub_18035FF30  @ 0x18035FF30  (RVA 0x35FF30)  floats=21
...
double __fastcall sub_18035FF30(__int64 a1, int a2, int a3)
{
  int v6; // r9d
  __int64 v7; // r8
  __int64 v8; // rdx
  ...
  *(_DWORD *)(a1 + 32) = a3;
  ...
  if ( a2 )
  {
    ...
    sub_1803C1090(*(_QWORD *)(a1 + 8), *(unsigned int *)(a1 + 92), *(unsigned int *)(a1 + 168));
    sub_1803C1090(*(_QWORD *)(a1 + 8), *(unsigned int *)(a1 + 92), *(unsigned int *)(a1 + 172));
    sub_1803C1090(*(_QWORD *)(a1 + 8), *(unsigned int *)(a1 + 92), *(unsigned int *)(a1 + 176));
    sub_1803C1090(*(_QWORD *)(a1 + 8), *(unsigned int *)(a1 + 92), *(unsigned int *)(a1 + 180));
  }
  else
  {
    sub_1803C10D0(v17, v16, v14, 5 * v15, 0);
    sub_1803C10D0(*(_QWORD *)(a1 + 8), *(_DWORD *)(a1 + 92), *(_DWORD *)(a1 + 168), v18, 0);
    sub_1803C10D0(*(_QWORD *)(a1 + 8), *(_DWORD *)(a1 + 92), *(_DWORD *)(a1 + 172), v19, 0);
    sub_1803C10D0(*(_QWORD *)(a1 + 8), *(_DWORD *)(a1 + 92), *(_DWORD *)(a1 + 176), v20, 0);
    sub_1803C10D0(*(_QWORD *)(a1 + 8), *(_DWORD *)(a1 + 92), *(_DWORD *)(a1 + 180), v21, 0);
  }
