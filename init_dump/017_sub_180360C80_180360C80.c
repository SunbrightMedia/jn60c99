// sub_180360C80  @ 0x180360C80  (RVA 0x360C80)  floats=21
...
double __fastcall sub_180360C80(__int64 a1, int a2, int a3)
{
  int v6; // r9d
  __int64 v7; // r8
  __int64 v8; // rdx
  ...
  *(_DWORD *)(a1 + 88) = a3;
  ...
  if ( a2 )
  {
    ...
    sub_1803C1090(*(_QWORD *)(a1 + 8), *(unsigned int *)(a1 + 152), *(unsigned int *)(a1 + 328));
    sub_1803C1090(*(_QWORD *)(a1 + 8), *(unsigned int *)(a1 + 152), *(unsigned int *)(a1 + 332));
    sub_1803C1090(*(_QWORD *)(a1 + 8), *(unsigned int *)(a1 + 152), *(unsigned int *)(a1 + 336));
    sub_1803C1090(*(_QWORD *)(a1 + 8), *(unsigned int *)(a1 + 152), *(unsigned int *)(a1 + 340));
  }
  else
  {
    sub_1803C10D0(v17, v16, v14, 5 * v15, 0);
    sub_1803C10D0(*(_QWORD *)(a1 + 8), *(_DWORD *)(a1 + 152), *(_DWORD *)(a1 + 328), v18, 0);
    sub_1803C10D0(*(_QWORD *)(a1 + 8), *(_DWORD *)(a1 + 152), *(_DWORD *)(a1 + 332), v19, 0);
    sub_1803C10D0(*(_QWORD *)(a1 + 8), *(_DWORD *)(a1 + 152), *(_DWORD *)(a1 + 336), v20, 0);
    sub_1803C10D0(*(_QWORD *)(a1 + 8), *(_DWORD *)(a1 + 152), *(_DWORD *)(a1 + 340), v21, 0);
  }
  v23 = *(unsigned int *)(a1 + 344);
