// sub_1803628D0  @ 0x1803628D0  (RVA 0x3628D0)  floats=21
...
double __fastcall sub_1803628D0(__int64 a1, int a2, int a3)
{
  int v6; // r9d
  __int64 v7; // r8
  __int64 v8; // rdx
  ...
  *(_DWORD *)(a1 + 32) = a3;
  ...
  if ( a2 )
  {
    ...
    sub_1803C1090(*(_QWORD *)(a1 + 8), *(unsigned int *)(a1 + 92), *(unsigned int *)(a1 + 184));
    sub_1803C1090(*(_QWORD *)(a1 + 8), *(unsigned int *)(a1 + 92), *(unsigned int *)(a1 + 188));
    sub_1803C1090(*(_QWORD *)(a1 + 8), *(unsigned int *)(a1 + 92), *(unsigned int *)(a1 + 192));
    sub_1803C1090(*(_QWORD *)(a1 + 8), *(unsigned int *)(a1 + 92), *(unsigned int *)(a1 + 196));
  }
  else
  {
    sub_1803C10D0(v17, v16, v14, 5 * v15, 0);
    sub_1803C10D0(*(_QWORD *)(a1 + 8), *(_DWORD *)(a1 + 92), *(_DWORD *)(a1 + 184), v18, 0);
    sub_1803C10D0(*(_QWORD *)(a1 + 8), *(_DWORD *)(a1 + 92), *(_DWORD *)(a1 + 188), v19, 0);
    sub_1803C10D0(*(_QWORD *)(a1 + 8), *(_DWORD *)(a1 + 92), *(_DWORD *)(a1 + 192), v20, 0);
    sub_1803C10D0(*(_QWORD *)(a1 + 8), *(_DWORD *)(a1 + 92), *(_DWORD *)(a1 + 196), v21, 0);
  }
