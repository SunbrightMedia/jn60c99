...
LABEL_164:
    ...
    if ( v551 > 4 )
    {
      ...
      {
        {
          static eb_fx_e5_coef C_; static unsigned char H_;
          static unsigned long G_; extern unsigned long eb_coef_gen;
          static int SH; eb_fx_e5_state st; float a56,a58,a593; int wi; float sv;
          if (!H_ || G_ != eb_coef_gen) {
            C_.k96336 = *(float *)(a1 + 96336);
            C_.k96352 = *(float *)(a1 + 96352);
            C_.k96368 = *(float *)(a1 + 96368);
            C_.k96384 = *(float *)(a1 + 96384);
            C_.k96400 = *(float *)(a1 + 96400);
            C_.k96416 = *(float *)(a1 + 96416);
            C_.k96432 = *(float *)(a1 + 96432);
            C_.k96448 = *(float *)(a1 + 96448);
            C_.k96464 = *(float *)(a1 + 96464);
            C_.k96480 = *(float *)(a1 + 96480);
            C_.k96496 = *(float *)(a1 + 96496);
            C_.k96512 = *(float *)(a1 + 96512);
            C_.k96528 = *(float *)(a1 + 96528);
            C_.k96544 = *(float *)(a1 + 96544);
            C_.k96560 = *(float *)(a1 + 96560);
            C_.k96576 = *(float *)(a1 + 96576);
            C_.k96592 = *(float *)(a1 + 96592);
            C_.k96608 = *(float *)(a1 + 96608);
            C_.k96624 = *(float *)(a1 + 96624);
            C_.k96640 = *(float *)(a1 + 96640);
            C_.k96656 = *(float *)(a1 + 96656);
            C_.k96672 = *(float *)(a1 + 96672);
            C_.k96688 = *(float *)(a1 + 96688);
            C_.k96704 = *(float *)(a1 + 96704);
            C_.k96720 = *(float *)(a1 + 96720);
            C_.k96736 = *(float *)(a1 + 96736);
            C_.k96752 = *(float *)(a1 + 96752);
            C_.k96768 = *(float *)(a1 + 96768);
            C_.k96784 = *(float *)(a1 + 96784);
            C_.k96800 = *(float *)(a1 + 96800);
            C_.k96816 = *(float *)(a1 + 96816);
            C_.k96832 = *(float *)(a1 + 96832);
            C_.k96848 = *(float *)(a1 + 96848);
            C_.k96864 = *(float *)(a1 + 96864);
            C_.k96880 = *(float *)(a1 + 96880);
            C_.k96896 = *(float *)(a1 + 96896);
            C_.k96912 = *(float *)(a1 + 96912);
            C_.k101028 = *(int32_t *)(a1 + 101028);
            H_=1; G_=eb_coef_gen; }
          st.s84672 = *(float *)(a1 + 84672);
          st.s95888 = *(float *)(a1 + 95888);
          st.s95904 = *(float *)(a1 + 95904);
          st.s95920 = *(float *)(a1 + 95920);
          st.s95936 = *(float *)(a1 + 95936);
          st.s95952 = *(float *)(a1 + 95952);
          st.s95968 = *(float *)(a1 + 95968);
          st.s95984 = *(float *)(a1 + 95984);
          st.s96000 = *(float *)(a1 + 96000);
          st.s96016 = *(float *)(a1 + 96016);
          st.s96032 = *(float *)(a1 + 96032);
          st.s96048 = *(float *)(a1 + 96048);
          st.s96064 = *(float *)(a1 + 96064);
          st.s96080 = *(float *)(a1 + 96080);
          st.s96096 = *(float *)(a1 + 96096);
          st.s96112 = *(float *)(a1 + 96112);
          st.s96128 = *(float *)(a1 + 96128);
          st.s96144 = *(float *)(a1 + 96144);
          st.s96160 = *(float *)(a1 + 96160);
          st.s96176 = *(float *)(a1 + 96176);
          st.s96192 = *(float *)(a1 + 96192);
          st.s96208 = *(float *)(a1 + 96208);
          st.s96224 = *(float *)(a1 + 96224);
          st.s96240 = *(float *)(a1 + 96240);
          st.s96256 = *(float *)(a1 + 96256);
          st.s96272 = *(float *)(a1 + 96272);
          st.s96288 = *(float *)(a1 + 96288);
          st.s96304 = *(float *)(a1 + 96304);
          st.s96320 = *(float *)(a1 + 96320);
          st.s101040 = *(float *)(a1 + 101040);
          st.s101056 = *(float *)(a1 + 101056);
          st.s101060 = *(float *)(a1 + 101060);
          st.s101064 = *(float *)(a1 + 101064);
          st.s101024 = *(int32_t *)(a1 + 101024);
          st.ring = (float *)(a1 + 96928);
          wi = (st.s101024 - 1) & (C_.k101028 - 1); sv = st.ring[wi];
          eb_fx_e5_tick(&st, &C_, *(float *)(a1 + 84624), &a56, &a58, &a593);
          st.ring[wi] = sv;
          EB5[0]=a56; EB5[1]=a58; EB5[2]=a593;
          EB5S[0]=st.s84672;
          EB5S[1]=st.s95888;
          EB5S[2]=st.s95904;
          EB5S[3]=st.s95920;
