...
void eb_master_coefs_build(const unsigned char *base, eb_master_coef *c)
{
    ...
    c->d4.k101744 = CF(base, 101744);
    c->d4.k6429472 = CF(base, 6429472);
    c->d4.k6429488 = CF(base, 6429488);
    c->d4.k6429568 = CF(base, 6429568);
    c->d4.k6429808 = CF(base, 6429808);
    c->d4.k6429824 = CF(base, 6429824);
    c->d4.k6429856 = CF(base, 6429856);
    c->d4.k6429872 = CF(base, 6429872);
    c->d4.k6430464 = CF(base, 6430464);
    c->d4.k6430480 = CF(base, 6430480);
    c->d4.k6430496 = CF(base, 6430496);
    c->d4.k6430512 = CF(base, 6430512);
    c->d4.k6430528 = CF(base, 6430528);
    c->d4.k6430544 = CF(base, 6430544);
    c->d4.k6430560 = CF(base, 6430560);
    c->d4.k6430576 = CF(base, 6430576);
    c->d4.k6430592 = CF(base, 6430592);
    c->d4.k6430608 = CF(base, 6430608);
    c->d4.k6430624 = CF(base, 6430624);
    c->d4.k6430640 = CF(base, 6430640);
    c->d4.k6430656 = CF(base, 6430656);
    c->d4.k6430672 = CF(base, 6430672);
    c->d4.k6430688 = CF(base, 6430688);
    c->d4.k6430704 = CF(base, 6430704);
    c->d4.k6430720 = CF(base, 6430720);
    c->d4.k6430736 = CF(base, 6430736);
    c->d4.k6430752 = CF(base, 6430752);
    c->d4.k6430768 = CF(base, 6430768);
    c->d4.k6430784 = CF(base, 6430784);
    c->d4.k6430800 = CF(base, 6430800);
    c->d4.k6430816 = CF(base, 6430816);
    c->d4.k6430832 = CF(base, 6430832);
    c->d4.k6430848 = CF(base, 6430848);
    c->d4.k6430864 = CF(base, 6430864);
    c->d4.k6430880 = CF(base, 6430880);
    c->d4.k6430896 = CF(base, 6430896);
    c->d4.k6430912 = CF(base, 6430912);
    c->d4.k6430928 = CF(base, 6430928);
    c->d4.k6463716 = CI(base, 6463716);
    c->d4.k6496500 = CI(base, 6496500);

    c->e0.k85136 = CF(base, 85136);
    c->e0.k85152 = CF(base, 85152);
    c->e0.k85168 = CF(base, 85168);
    c->e0.k85184 = CF(base, 85184);
    c->e0.k85200 = CF(base, 85200);
    c->e0.k85216 = CF(base, 85216);
    c->e0.k85232 = CF(base, 85232);
    c->e0.k85248 = CF(base, 85248);
    c->e0.k85264 = CF(base, 85264);
    c->e0.k85280 = CF(base, 85280);
    c->e0.k85296 = CF(base, 85296);
    c->e0.k85312 = CF(base, 85312);
    c->e0.k85328 = CF(base, 85328);
    c->e0.k85344 = CF(base, 85344);
    c->e0.k85360 = CF(base, 85360);
    c->e0.k85376 = CF(base, 85376);
    c->e0.k85392 = CF(base, 85392);
    c->e0.k85408 = CF(base, 85408);
    c->e0.k85424 = CF(base, 85424);
    c->e0.k85440 = CF(base, 85440);
    c->e0.k85456 = CF(base, 85456);
    c->e0.k85472 = CF(base, 85472);
    c->e0.k85488 = CF(base, 85488);
    c->e0.k85504 = CF(base, 85504);
    c->e0.k85520 = CF(base, 85520);
    c->e0.k85536 = CF(base, 85536);
    c->e0.k85552 = CF(base, 85552);
    c->e0.k85568 = CF(base, 85568);
    c->e0.k85744 = CF(base, 85744);
    c->e0.k85760 = CF(base, 85760);
    c->e0.k85776 = CF(base, 85776);
    c->e0.k85792 = CF(base, 85792);
    c->e0.k85808 = CF(base, 85808);
    c->e0.k85824 = CF(base, 85824);
    c->e0.k85840 = CF(base, 85840);
    c->e0.k85856 = CF(base, 85856);
    c->e0.k85872 = CF(base, 85872);
    c->e0.k85888 = CF(base, 85888);
    c->e0.k85984 = CF(base, 85984);
    c->e0.k86000 = CF(base, 86000);
    c->e0.k86016 = CF(base, 86016);
    c->e0.k86032 = CF(base, 86032);
    c->e0.k86048 = CF(base, 86048);
    c->e0.k86064 = CF(base, 86064);
    c->e0.k86080 = CF(base, 86080);
...
void eb_master_state_seed(const unsigned char *base, eb_master_state *s)
{
    ...
    s->d4.s6429504 = CF(base, 6429504);
    s->d4.s6429520 = CF(base, 6429520);
    s->d4.s6429536 = CF(base, 6429536);
    s->d4.s6429760 = CF(base, 6429760);
    s->d4.s6429776 = CF(base, 6429776);
    s->d4.s6429792 = CF(base, 6429792);
    s->d4.s6429840 = CF(base, 6429840);
    s->d4.s6429888 = CF(base, 6429888);
    s->d4.s6429904 = CF(base, 6429904);
    s->d4.s6429920 = CF(base, 6429920);
    s->d4.s6429936 = CF(base, 6429936);
    s->d4.s6429952 = CF(base, 6429952);
    s->d4.s6429968 = CF(base, 6429968);
    s->d4.s6429984 = CF(base, 6429984);
    s->d4.s6430000 = CF(base, 6430000);
    s->d4.s6430016 = CF(base, 6430016);
    s->d4.s6430032 = CF(base, 6430032);
    s->d4.s6430048 = CF(base, 6430048);
    s->d4.s6430064 = CF(base, 6430064);
    s->d4.s6430080 = CF(base, 6430080);
    s->d4.s6430096 = CF(base, 6430096);
    s->d4.s6430112 = CF(base, 6430112);
    s->d4.s6430128 = CF(base, 6430128);
    s->d4.s6430144 = CF(base, 6430144);
    s->d4.s6430160 = CF(base, 6430160);
    s->d4.s6430176 = CF(base, 6430176);
    s->d4.s6430192 = CF(base, 6430192);
    s->d4.s6430208 = CF(base, 6430208);
    s->d4.s6430224 = CF(base, 6430224);
    s->d4.s6430240 = CF(base, 6430240);
    s->d4.s6430256 = CF(base, 6430256);
    s->d4.s6430272 = CF(base, 6430272);
    s->d4.s6430288 = CF(base, 6430288);
    s->d4.s6430304 = CF(base, 6430304);
    s->d4.s6430320 = CF(base, 6430320);
    s->d4.s6430336 = CF(base, 6430336);
    s->d4.s6430352 = CF(base, 6430352);
    s->d4.s6430368 = CF(base, 6430368);
    s->d4.s6430384 = CF(base, 6430384);
    s->d4.s6430400 = CF(base, 6430400);
    s->d4.s6430416 = CF(base, 6430416);
    s->d4.s6430432 = CF(base, 6430432);
    s->d4.s6430448 = CF(base, 6430448);
    s->d4.s6496512 = CF(base, 6496512);
    s->d4.s6496528 = CF(base, 6496528);
    s->d4.s6496532 = CF(base, 6496532);
    s->d4.s6496536 = CF(base, 6496536);
    s->d4.s6496544 = CF(base, 6496544);
    s->d4.s6496560 = CF(base, 6496560);
    s->d4.s6496564 = CF(base, 6496564);
    s->d4.s6496568 = CF(base, 6496568);
    s->d4.s6463712 = CI(base, 6463712);
    s->d4.s6496496 = CI(base, 6496496);
    s->d4.s11022348 = CI(base, 11022348);

    s->e0.s84672 = CF(base, 84672);
    s->e0.s84896 = CF(base, 84896);
    s->e0.s84912 = CF(base, 84912);
    s->e0.s84928 = CF(base, 84928);
    s->e0.s84944 = CF(base, 84944);
    s->e0.s84960 = CF(base, 84960);
    s->e0.s84976 = CF(base, 84976);
    s->e0.s84992 = CF(base, 84992);
    s->e0.s85008 = CF(base, 85008);
    s->e0.s85024 = CF(base, 85024);
    s->e0.s85040 = CF(base, 85040);
    s->e0.s85056 = CF(base, 85056);
    s->e0.s85072 = CF(base, 85072);
    s->e0.s85088 = CF(base, 85088);
    s->e0.s85104 = CF(base, 85104);
    s->e0.s85120 = CF(base, 85120);
    s->e0.s85584 = CF(base, 85584);
    s->e0.s85600 = CF(base, 85600);
    s->e0.s85616 = CF(base, 85616);
    s->e0.s85632 = CF(base, 85632);
    s->e0.s85648 = CF(base, 85648);
    s->e0.s85664 = CF(base, 85664);
    s->e0.s85680 = CF(base, 85680);
    s->e0.s85696 = CF(base, 85696);
    s->e0.s85712 = CF(base, 85712);
    s->e0.s85728 = CF(base, 85728);
    s->e0.s85904 = CF(base, 85904);
    s->e0.s85920 = CF(base, 85920);
    s->e0.s85936 = CF(base, 85936);
    s->e0.s85952 = CF(base, 85952);
    s->e0.s85968 = CF(base, 85968);
