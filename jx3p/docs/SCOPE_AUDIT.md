...
Rows 1, 2 and 14 below are now CLOSED. The rest stand as written.
...
| 2 | Voice compare window | **CLOSED** — +0xA6BFD0 traced to a ramp writer, not a hole | window 0x60000, but a real f32 DSP cell at **+0xA6BFD0** changes during render (0.9637→1.0) and is NEVER compared |
