...
emcc -std=c99 -O2 -ffp-contract=off -fno-strict-aliasing -sGROWABLE_ARRAYBUFFERS=0 \
  ...
  -s EXPORTED_FUNCTIONS='["_juno_gui_create","_juno_gui_set","_juno_gui_get","_juno_gui_recall_factory","_juno_gui_set_chorus_mode","_juno_gui_gate","_juno_gui_note_on","_juno_gui_note_off","_juno_gui_midi_note_on","_juno_gui_midi_note_off","_juno_gui_set_kbd_velocity","_juno_gui_arp_config","_juno_gui_set_tempo","_juno_gui_get_arp","_juno_gui_apply_bank","_juno_gui_render","_juno_gui_render_dry","_juno_gui_param_count","_juno_gui_param_name","_juno_gui_param_offset","_juno_gui_param_blob","_juno_gui_set_param","_juno_gui_host_count","_juno_gui_host_name","_juno_gui_host_section","_juno_gui_host_min","_juno_gui_host_max","_juno_gui_host_get","_juno_gui_host_set","_juno_gui_warmup","_malloc","_free"]' \
