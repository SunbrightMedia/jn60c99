 ...
 *
 * While it is still verbatim the residual must be EXACTLY 0 -- that is the
 * substrate's own passthrough proof, and it is what makes any later non-zero
 * residual attributable to the edit that produced it rather than to the harness.
 *
 * WHY A FORK AND NOT AN EDIT. src/voice_render.c is a party to the bit-exact
 ...
 * upstream file has moved since the fork and the SHA below was not refreshed
 * with a fresh null run):
 *   forked from : src/voice_render.c
 *   at sha256   : aba0925a1505c7c4564533f77e2b6f9aefa893ad9126d93362153fcec6017355
 *   fork state  : VERBATIM (no native rewrite applied yet) + one #ifdef-guarded
 *                 observability hook at the tail of juno_voice_render, which
 *                 emits no code unless -DTRACKB_PERTURB_CELLS is passed.
 *
 * Everything below this header is the unmodified upstream file.
 */
...
LABEL_46:
  ...
  v124 = JF(a1, 560) * v123;
  JF(a1, 2576) = v124;
  JI(a1, 2608) = JI(a1, 2592);
  JI(a1, 2656) = JI(a1, 2640);
  JI(a1, 2640) = JI(a1, 2624);
  JI(a1, 2688) = JI(a1, 2672);
  JI(a1, 2736) = JI(a1, 2720);
  if ( (float)(v124 + JF(a1, 2864)) >= 0.0 )
    v125 = 0.0;
  else
    v125 = 1.0;
  v126 = 1.0 - v125;
  v127 = (float)(1.0 - v125) * (float)((float)(JF(a1, 2896) * JF(a1, 2656)) + JF(a1, 2608));
  JF(a1, 2624) = v127;
  v128 = v127 + JF(a1, 2880);
  v129 = v127 - JF(a1, 2640);
  JF(a1, 2704) = (float)((float)(JF(a1, 2848) * JF(a1, 2960))
                                - (float)(JF(a1, 2928) * JF(a1, 2848)))
                        + JF(a1, 2928);
  if ( v128 < 0.0 )
    v130 = 0.0;
  else
  ...
  if ( v129 < 0.0 )
    v130 = 1.0 - v125;
  v131 = JF(a1, 2784);
  v132 = v126 * (float)(JF(a1, 2800) * JF(a1, 2928));
  JF(a1, 2640) = v130;
  v133 = JF(a1, 2688);
  v134 = (float)(v132 - (float)(JF(a1, 2944) * v126)) + JF(a1, 2944);
  v135 = v126 * (float)(1.0 - v130);
  v136 = (float)((float)(JF(a1, 2816) * 0.00390625) * v130) + (float)((float)(v131 * 0.00390625) * v135);
  if ( (float)(v134 - v133) > 0.0 )
    v134 = v133 + JF(a1, 2704);
  v137 = JF(a1, 2608);
  v138 = fminf(JF(a1, 2928), v134);
  JF(a1, 2672) = v138;
  v139 = JF(a1, 2832);
  v140 = (float)((float)(v135 * JF(a1, 2912)) + (float)(v130 * v138)) - v137;
  v141 = (float)((float)(JF(a1, 2976) * v136) - (float)(JF(a1, 2976) * JF(a1, 2736)))
       + JF(a1, 2736);
  JF(a1, 2720) = v141;
  v142 = (float)((float)((float)((float)((float)(v139 * 0.00390625) * v125) - (float)(v125 * v141)) + v141) * v140)
       + v137;
  JF(a1, 2592) = v142;
  v143 = (float)(v142 * JF(a1, 2992)) * JF(a1, 3008);
  v144 = v143 * JF(a1, 3024);
  JF(a1, 2752) = v143;
  JF(a1, 2768) = v144;
  if ( JF(a1, 1824) <= 0.0 )
    v145 = 0.0;
  ...
  v146 = JF(a1, 560) * v145;
  JF(a1, 3056) = v146;
  JI(a1, 3088) = JI(a1, 3072);
  JI(a1, 3136) = JI(a1, 3120);
  JI(a1, 3120) = JI(a1, 3104);
  JI(a1, 3168) = JI(a1, 3152);
  JI(a1, 3216) = JI(a1, 3200);
  if ( (float)(v146 + JF(a1, 3344)) >= 0.0 )
    v147 = 0.0;
  else
    v147 = 1.0;
  v148 = 1.0 - v147;
  v149 = (float)(1.0 - v147) * (float)((float)(JF(a1, 3376) * JF(a1, 3136)) + JF(a1, 3088));
  JF(a1, 3104) = v149;
  v150 = v149 + JF(a1, 3360);
  v151 = v149 - JF(a1, 3120);
  JF(a1, 3184) = (float)((float)(JF(a1, 3328) * JF(a1, 3440))
                                - (float)(JF(a1, 3408) * JF(a1, 3328)))
                        + JF(a1, 3408);
  if ( v150 < 0.0 )
    v152 = 0.0;
  else
  ...
  if ( v151 < 0.0 )
    v152 = 1.0 - v147;
  v153 = JF(a1, 3280) * JF(a1, 3408);
  v154 = JF(a1, 3264);
  JF(a1, 3120) = v152;
  v155 = JF(a1, 3168);
  v156 = (float)((float)(v148 * v153) - (float)(JF(a1, 3424) * v148)) + JF(a1, 3424);
  v157 = v148 * (float)(1.0 - v152);
  v158 = (float)((float)(JF(a1, 3296) * 0.00390625) * v152) + (float)((float)(v154 * 0.00390625) * v157);
  if ( (float)(v156 - v155) > 0.0 )
    v156 = v155 + JF(a1, 3184);
  v159 = JF(a1, 3088);
  v160 = fminf(JF(a1, 3408), v156);
  JF(a1, 3152) = v160;
  v161 = (float)(JF(a1, 3312) * 0.00390625) * v147;
  v162 = (float)((float)(v157 * JF(a1, 3392)) + (float)(v152 * v160)) - v159;
  v163 = (float)((float)(JF(a1, 3456) * v158) - (float)(JF(a1, 3456) * JF(a1, 3216)))
       + JF(a1, 3216);
  JF(a1, 3200) = v163;
  v164 = (float)((float)((float)(v161 - (float)(v147 * v163)) + v163) * v162) + v159;
  JF(a1, 3072) = v164;
  v165 = (float)(v164 * JF(a1, 3472)) * JF(a1, 3488);
  v166 = v165 * JF(a1, 3504);
  JF(a1, 3232) = v165;
  JF(a1, 3248) = v166;
