#!/usr/bin/env python3
"""held_gate.py -- build and run the HELD-narrowing gate.

Compiles tools/engineb/devboot/held_gate.c at the FIRMWARE's engine flag set
and runs a note sequence across three patches. See that file for what it
checks and why both of its checks are needed.
...
drift" -- a second copy of it here would be a second place.
  ...
  usage: held_gate.py [--nv 8] [--chord 2]
"""
import argparse
import os
import subprocess
