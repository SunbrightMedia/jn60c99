...
# JUNO_EB_ZEROCOEF=1: delete the coefficients zero_proof holds at 0.0 across
...
if os.environ.get("JUNO_EB_ZC_PROBE2"):
    CFLAGS = CFLAGS + ["-DEB_ZC_PROBE2=1"]

if os.environ.get("JUNO_EB_ZC_PROBE"):
    CFLAGS = CFLAGS + ["-DEB_ZC_PROBE=1"]

if os.environ.get("JUNO_EB_ATREST_O1"):
    CFLAGS = CFLAGS + ["-DEB_ATREST_O1=1", "-DEB_ATREST_O1_MIN=1"]
...
if os.environ.get("JUNO_EB_VCF_ILV"):
    CFLAGS = CFLAGS + ["-DEB_VCF_ILV=1"]
